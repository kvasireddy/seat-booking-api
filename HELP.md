...
* The original package name 'com.seats.booking-api' is invalid and this project uses 'com.seats.bookingapi' instead.
...
* [Apache Freemarker](https://docs.spring.io/spring-boot/docs/2.2.7.RELEASE/reference/htmlsingle/#boot-features-spring-mvc-template-engines)
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/2.2.7.RELEASE/reference/htmlsingle/#boot-features-spring-hateoas)
